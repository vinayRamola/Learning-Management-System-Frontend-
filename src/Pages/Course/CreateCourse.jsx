    ...
    return (
        <HomeLayout>
            ...
            <form
                ...
                className="flex flex-col justify-center gap-5 rounded-lg p-4 w-[700px] text-white my-10 shadow-[0_0_10px_black] relative"
            >
                        ...
                        <div>
                            <label htmlFor="image_uploads" className="cursor-pointer">
                                {userInput.previewImage ? (
                                    ...
                                    <div className="h-44 w-full m-auto flex items-center justify-center border">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <textarea
                                ...
                                className="bg-transparent px-2 py-1 h-24 overflow-y-scroll border"
                ...
                <button type="submit" className="w-full py-2 rounded-md font-semibold text-lg cursor-pointer bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300">Create Course</button>
